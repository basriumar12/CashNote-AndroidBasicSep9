...
public class UbahActivity_ViewBinding implements Unbinder {
  private UbahActivity target;
  ...
  @UiThread
  public UbahActivity_ViewBinding(UbahActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public UbahActivity_ViewBinding(final UbahActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    UbahActivity target = this.target;
